...
const Profile = () => {
  ...
  const validateName = (nameInput) => {
    var format = /[`!@#$%^&()+*_\-=\[\]{};':"\\|,.<>\/?~]/;
    if (format.test(nameInput)) {
      setNameErrorSign("ชื่อจริงห้ามมีอักขระพิเศษ");
    } else {
      setNameErrorSign("✔");
    }
  };
  ...
  const validateAddress = (e) => {
    ...
    var format = /[`!@#$%^&*_+\-=\[\]{};':"\\|<>\?~]/;
    if (format.test(addresesInput)) {
      setAddressErrorSign("ที่อยู่ห้ามมีอักขระพิเศษ");
    } else {
      setAddressErrorSign("✔");
    }
  };
  const validateRoad = (e) => {
    ...
    var format = /[`!@#$%^&*()_+\=\[\]{};':"\\|,.<>\/?~]/;
    if (format.test(roadInput)) {
      setRoadErrorSign("ชื่อผู้ใช้งานห้ามมีอักขระพิเศษ ");
    } else {
      setRoadErrorSign("✔");
    }
  };
  ...
  const submitEditForm = async (next) => {
    if (
      ...
      if (postalCode != "") {
        saveEditAccountData(Name, mobilePhone, postalCode);
        profileSwitch(1);
  ...
  const [dogDetail, setdogDetail] = useState({
    ...
    status: "",
    icon: (
      <FavoriteIcon className="icon_details_accept" style={{ fontSize: 45 }} />
    ),
    like: 5,
    question1: "",
    answer1: "",
  ...
  const [notPaidDogData, setNotPaidDogData] = useState([
    { name: "หมาชนิดแรก", picture: Profile_item1_src, price: 7000, amount: 1 },
    { name: "หมาชนิดสอง", picture: Profile_item2_src, price: 12000, amount: 1 },
  ]);

  const [paidDogData, setPaidDogData] = useState([
    {
      name: "หมาชนิดแรกจ่ายและ",
      picture: Profile_item1_src,
      price: 8000,
      amount: 1,
    },
    {
      name: "หมาชนิดสองจ่ายและ",
      picture: Profile_item2_src,
      price: 15000,
      amount: 1,
    },
  ]);
  ...
  const saveEditAccountData = (name, mobileNumber, postalCode) => {
  ...
  return (
    <div style={{ height: "100%", width: "100%", fontFamily: "Kanit" }}>
        ...
        <div className="content2">
            ...
            <div className="profile_bar">
              <div className="SidebarList">
                <li className="row">
                  ...
                  <div id="title" style={{ color: "#ED8E82" }}>
                    บัญชีของฉัน
                  </div>
                </li>
                <li
          ...
          <div className="account_details">
            ...
            <div className="Account_Text">
              ...
              <input
                disabled
                className="edit-input-no-cursor"
                type="text"
                value=""
        ...
        <div className="content2">
          ...
          <div className="like_page">
            {likeTab[0] && (
              <div className="temp-money-pane">
                <div className="money-tab">
                  ...
                  <text className="money-header" onClick={() => likeSwitch(2)}>
                    รอการตอบรับ
                  </text>
                  <text className="money-header" onClick={() => likeSwitch(3)}>
                    ตอบรับแล้ว
                  </text>
                </div>
                          ...
                          <div className="cards__wrapper" key={key}>
                            ...
                            >
                              <div className="img_list">
                                <img src={each.picture} className="img_list" />
                              </div>
                              <div className="img_text_bottom">
                                <text>{each.breed}</text>
                                <text>
                                  {each.typeSell === "บริจาค"
                                    ? "บริจาคฟรี"
                                    : "ราคา:" + each.cost}
                                </text>
                                <text>
            ...
            {likeTab[1] && (
              <div className="temp-money-pane">
                <div className="money-tab">
                  <text className="money-header" onClick={() => likeSwitch(1)}>
                    ทั้งหมด
                  </text>
        ...
        <div className="content2">
          ...
          <div className="store_page">
            {storeTab[0] && (
              <div className="temp-money-pane">
                <div className="money-tab">
                  ...
                  <text className="money-header" onClick={() => storeSwitch(2)}>
                    ขายแล้ว
                  </text>
                </div>
                <div className="cards_all">
                              ...
                              <div
                                ...
                                onClick={() => {
                                  localStorage.setItem(
                                    "petIdForStorePage",
                                    JSON.stringify(each.petId)
                                  );
                                  profileSwitch(6);
                                  setDogForSellToShow(each);
                                }}
                              >
                                <div className="img_list">
            ...
            {storeTab[1] && (
              <div className="temp-money-pane">
                <div className="money-tab">
                  <text className="money-header" onClick={() => storeSwitch(1)}>
                    กำลังขาย
                  </text>
                ...
                <div className="cards_all">
                  <div className="cards__container">
                    <div className="row_img">
                      {dataPet
                        .filter((e) => e.statusSell == false)
                        .map((each, key) => {
                          return (
                            <div className="cards__wrapper" key={key}>
                              <div
                                className="img_wrapper"
                                onClick={() => profileSwitch(6)}
                              >
                                <div className="img_list">
                                  <img src={each.picture} />
                                </div>
        ...
        <div className="content2">
          ...
          <div className="payment">
            {moneyTab[0] && (
              <div className="temp-money-pane">
                <div className="money-tab">
                  ...
                  <text className="money-header" onClick={() => moneySwitch(2)}>
                    ชำระแล้ว
                  </text>
                </div>
                <div className="money-info-pane">
                  <div className="money-table-row">
                    ...
                    <div className="col3-name-header">
                      <div class=".center-div-black">สุนัข</div>
                    </div>
                    <div className="col4-price-header">
                      <div class=".center-div-black">ราคา</div>
                    </div>
                    <div className="col6-total-header">
                      <div class=".center-div-black">ชำระเงิน</div>
                    </div>
                    <div class="col4-price-header">
                      <div class=".center-div-black">ยกเลิก</div>
                    </div>
                  </div>
                  {dataPetForLike
                    .filter(
                    ...
                    .map((each) => {
                      ...
                      return (
                        <div className="money-table-row">
                          <div class="col2-pic">
                            <img
                              className="money-table-pic"
                              src={each.picture}
                            />
                          </div>
                          <div className="col3-name">
                            <div className=".center-div-black">
                              {each.breed}
                            </div>
                          </div>
                          <div className="col4-price">
                            <div className=".center-div-pink">{each.cost}</div>
                          </div>
                          <div className="col6-total">
                            <div className=".center-div-pink">
                              <button
                                class="money-button"
                                onClick={() => {
                                  showPopUp("Sell");
                                  setChoosePayment(each);
                                }}
                              >
                                ซื้อสุนัข
                              </button>
                          ...
                          <div class="col4-price">
                            <div
                              class="col1-tools"
                              onClick={() => cancelPaidDog(each)}
                            >
                              X
                            </div>
                          </div>
            ...
            {moneyTab[1] && (
              <div className="temp-money-pane">
                <div className="money-tab">
                  <text className="money-header" onClick={() => moneySwitch(1)}>
                    ที่ต้องชำระ
                  </text>
                ...
                <div className="money-info-pane">
                  <div className="money-table-row">
                    ...
                    <div className="col5-amount-header">
                      <div class=".center-div-black">จำนวน</div>
                    </div>
                    <div className="col6-total-header">
                      <div class=".center-div-black">ชำระเงิน</div>
                    </div>
                    <div class="col4-price-header">
                      <div class=".center-div-black"></div>
                    </div>
                  </div>
                  {paidDogData &&
                    paidDogData.map((each) => {
                      return (
                        <div className="money-table-row">
                          <div class="col2-pic">
                            <img
                          ...
                          <div className="col3-name">
                            <div className=".center-div-black">{each.name}</div>
                          </div>
                          <div className="col4-price">
                            <div className=".center-div-pink">{each.price}</div>
                          </div>
                          <div className="col5-amount">
                            <div className=".center-div-black">
                              {each.amount}
                            </div>
                          </div>
                    ...
                    <div className="edit-profile-input-block2">
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          let tempPassSTR = tempVVV.replace(
                            /[^A-Za-zก-ฮ]/gi,
                            ""
                          );
            ...
            <div className="edit-input-row-right-main">
              ...
              <div className="edit-input-col-center">
                <div className="edit-input-row-left">
                  ...
                  <div className="edit-profile-input-block">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        let tempPassSTR = curPassvalue.replace(
                          /[^0-9A-Za-z]/gi,
                          ""
                        );
                  ...
                  <div className="edit-input-error-box"></div>
                </div>
            ...
            <div className="store_page2">
              <div className="Dog_box">
                ...
                <div className="Text_card">
                  <div className="cancel" onClick={() => profileSwitch(3)}>
                    <CancelIcon className="C_hover" style={{ fontSize: 70 }} />
                  </div>
                  <div className="text_card_text1">
                    {dogForSellToShow.breed}
                  </div>
                  <div className="text_card_text2">
                    {dogForSellToShow.typeSell === "บริจาค"
                      ? "บริจาคฟรี"
                      : "ราคา :" + " " + dogForSellToShow.cost}
                  </div>
                  <div className="text_card_text1">
                    {"เพศ :" + " " + dogForSellToShow.gender}
                  </div>
                  <div className="text_card_text1">
                    {"อายุ :" + " " + dogForSellToShow.age}
                  </div>
                  <div className="text_card_text1">{"รายละเอียด :"}</div>
                  <div
                    className="text_card_text3"
                    style={{
                      width: "500px",
                      height: "170px",
                      overflowY: "auto",
                  ...
                  >
                    {dogForSellToShow.detail}
                  </div>
                  <div className="text_card_text4">
                    {"ลงขายเมื่อวันที่ :" + " " + dogForSellToShow.dateCreate}
                  </div>
                </div>
              </div>
              {likeNameTab[0] && (
                <div className="like_card">
                  <div className="like_button_box">
                    <button
                      className="like_button_details_selected"
                      onClick={() => likeNameSwitch(1)}
                    >
                      คนสนใจ
                    </button>
                    <button
                      className="like_button_details"
                      onClick={() => likeNameSwitch(2)}
                    >
                      ยอมรับ
                    </button>
                    <button
                      className="like_button_details"
                      onClick={() => likeNameSwitch(3)}
                    >
                      ยกเลิก
                    </button>
                  </div>
                  <div className="like_card_details">
                    <div className="Text_like_all">
                      {"จำนวน" +
                        " " +
                        dogForSellToShow.likeUser.length +
                        " " +
                        "คนสนใจ"}
                    </div>
                    {dogForSellToShow.likeUser.map((each) => {
                      return (
                        ...
                        >
                          <div className="img_block_user_detail">
                            <img className="img_user_list" src={each.picture} />
                          </div>
                          <div className="name_block_user_detail">
                            {each.name}
                          </div>
                        </div>
                      );
                ...
                <div className="like_card">
                  ...
                  <div className="like_card_details">
                    <div className="Text_like_all">
                      {"จำนวน" +
                        " " +
                        dogForSellToShow.acceptUser.length +
                        " " +
                        "คนสนใจ"}
                    </div>
                    {dogForSellToShow.acceptUser.map((each) => {
                      return (
                        <div
                          ...
                          onClick={() => {
                            setUserAnswer(each);
                            setPopUpAnsType(false);
                            showPopUp("Answer");
                            setChoosePeopleForAccept(each);
                            localStorage.setItem(
                              "likeUser",
                              JSON.stringify(each)
                            );
                        ...
                        >
                          <div className="img_block_user_detail">
                            <img className="img_user_list" src={each.picutre} />
                          </div>
                          <div className="name_block_user_detail">
                            {each.name}
                          </div>
                ...
                <div className="like_card">
                  ...
                  <div className="like_card_details">
                    <div className="Text_like_all">
                      {"จำนวน" +
                        " " +
                        dogForSellToShow.cancelUser.length +
                        " " +
                        "คนสนใจ"}
                    </div>
      ...
      {popUpPay && (
        <PopUppayment setPopUp={setPopUpPay} getTotalPaid={choosePayment} />
      )}
