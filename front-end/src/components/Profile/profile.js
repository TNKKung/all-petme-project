...
const Profile = () => {
    ...
    const submitEditForm = async (next) => {
        ...
        if (
            ...
            saveEditAccountData(Name,
                ...
                postalCode)
            profileSwitch(1)
              const res = await fetch('https://api2.evera.cloud/updateProfileUser',{
                  method: 'PUT',
                  headers :{
    ...
    const fetDataForLike = async() => {
        const res = await fetch('https://api2.evera.cloud/dataPetForLike',{
                  method: 'post',
                  headers :{
                    "Content-Type":"application/json",
                    "Accept":"application/json"
    ...
    const submitEditPassForm = async (next) => {
        if (passErrorSign == 'OK' && ( password_storer[1] == password_storer[2])) {      
            ...
            const res = await fetch('https://api2.evera.cloud/checkPasswordAndUpdate',{
                  method: 'PUT',
                  headers :{
                    "Content-Type":"application/json",
                    "Accept":"application/json"
    ...
    const logOut = () => {
        localStorage.removeItem("user")
        window.open('petme.evera.cloud/login');
        window.close("_self");
    }
    ...
    const fetchPromtpay = async(e) => {
        ...
        const res = await fetch('https://api2.evera.cloud/promtpay',{
          method: 'POST',
            headers: {
                'Content-Type': 'application/json', 
                'Accept': 'application/json'    
    ...
    const fetchDataMyMarket = async() => {
        const res = await fetch('https://api2.evera.cloud/dataPetMyStore',{
          method: 'POST',
            headers: {
                'Content-Type': 'application/json'     
            },
    ...
    const fetchDataPictureProfile = async (e) => {
        ...
        const res = await fetch("https://api2.evera.cloud/uploadProfile", {
          method: "POST",
          body: formData,
        })
          .then((res) => res.text())
