...
const PopUpDogDetail = (props) => {
    ...
    const fetchdata = async() => {
        ...
        const res = await fetch('http://api2.evera.cloud/addAnswer',{
          method: 'POST',
            headers: {
    ...
    const fetchDataCancelRegis = async(e) => {
        console.log(e)
        const res = await fetch('http://api2.evera.cloud/cancelRegis',{
                  method: 'DELETE',
                  headers :{
                    "Content-Type":"application/json",
    ...
    const fetchDataCancelLike = async(e) =>{
        const res = await fetch('http://api2.evera.cloud/cancelLike',{
                  method: 'DELETE',
                  headers :{
                    "Content-Type":"application/json",
                    "Accept":"application/json"
    ...
    const fetchDataReport = async() =>{
        const res = await fetch('http://api2.evera.cloud/report',{
                  method: 'POST',
                  headers :{
                    "Content-Type":"application/json",
                    "Accept":"application/json"
