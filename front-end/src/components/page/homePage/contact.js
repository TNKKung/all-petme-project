...
const Contact = () => {
  ...
  function CheckName(val) {
    if (Name.length <= 0) {
      setAlertBoxName(true);
      setNameBorder("contract-inputTextB-alert");
      return true;
    } else {
      setAlertBoxName(false);
      setNameBorder("contract-inputTextB");
      return false;
    }
  }
  ...
  function CheckEmail(val) {
    if (
      Email.length <= 0 ||
      !Email.includes("@") ||
      !(Email.includes("com") || val.target.value.includes("co.th"))
    ) {
      setAlertBoxEmail(true);
      setEmailBorder("contract-inputTextB-alert");
      return true;
    } else {
      setAlertBoxEmail(false);
      setEmailBorder("contract-inputTextB");
      return false;
    }
  }
  ...
  function CheckPhone(val) {
    if (PhoneNumber.length != 10) {
      setAlertBoxPhone(true);
      setPhoneBorder("contract-inputTextB-alert");
      return true;
    } else {
      setAlertBoxPhone(false);
      setPhoneBorder("contract-inputTextB");
      return false;
    }
  }
  ...
  function CheckTopic(val) {
    if (Topic.length <= 0) {
      setAlertBoxTopic(true);
      setTopicBorder("contract-inputTextB-alert");
      return true;
    } else {
      setAlertBoxTopic(false);
      setTopicBorder("contract-inputTextB");
      return false;
    }
  }
  ...
  function CheckTextbox(val) {
    if (Textbox.length <= 0) {
      setAlertBoxTextbox(true);
      setTextboxBorder("contract-inputTextBLong-alert");
      return true;
    } else {
      setAlertBoxTextbox(false);
      setTextboxBorder("contract-inputTextBLong");
      return false;
    }
  }
  function getTextbox(val) {
    setTextbox(val.target.value);
  }
      ...
      <div className="sizePane">
        ...
        <div className="pageStyle">
          <div class="contract-Topic">
            <img
              class="contract-aboutTopic-bg"
              src={about_background_src}
            ></img>
            ...
            <div className="contract-addressContractWrap">
              <div className="contract-addressBox">
                ...
                <div className="contract-textBox">
                  <img
                    className="contract-logoAddress"
                    src={Address_icon_black_src}
                  ></img>
                  <p className="contract-textAddress">
                    เลขที่ 1 ซอยฉลองกรุง 1 เขตลาดกระบัง กรุงเทพมหานคร ประเทศไทย
                    10520
                  </p>
                </div>
                <div className="contract-textBox">
              ...
              <div className="contract-contractBox">
                ...
                <div className="contract-inputLayer">
                  <div>
                    ...
                    ></input>
                    {alertBoxName ? (
                      <p className="contract-alert-text">กรุณากรอกชื่อ</p>
                    ) : null}
                  </div>
                  ...
                  <div>
                    ...
                    ></input>
                    {alertBoxEmail ? (
                      <p className="contract-alert-text">
                ...
                <div className="contract-inputLayer">
                  <div>
                    ...
                    {alertBoxPhone ? (
                      <p className="contract-alert-text">
                        กรุณากรอกเบอร์ให้ถูกต้อง 0xxxxxxxxx
                      </p>
                    ) : null}
                  </div>
                  ...
                  <div>
                    ...
                    ></input>
                    {alertBoxTopic ? (
                      <p className="contract-alert-text">กรุณากรอกหัวข้อ</p>
                    ) : null}
                  </div>
                </div>
                <textarea
                ...
                ></textarea>
                {alertBoxTextbox ? (
                  <p className="contract-alert-text">กรุณาพิมพ์เนื้อหา</p>
                ) : null}

                <button className="contract-buttonSumit" onMouseUp={checkSumit}>
                  ส่ง
                </button>
          ...
          <div style={{ height: "300px", width: "100%" }}>
            <GoogleMapReact
              ...
              defaultCenter={{
                lat: 13.727732292542216,
                lng: 100.77078854813402,
              }}
              defaultZoom={18}
            >
