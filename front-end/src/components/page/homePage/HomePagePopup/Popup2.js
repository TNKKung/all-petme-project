...
function Popup2({ popup1, popup2, popupFinish, setType }) {
  ...
  const [dataimage4, setDataimage4] = useState({});
  const [dataimage5, setDataimage5] = useState({});
            ...
            <div className="show-picture">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setForm({
                    ...form,
                    subPicture1: URL.createObjectURL(e.target.files[0]),
                  });
            ...
            <div className="show-picture">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setForm({
                    ...form,
                    subPicture2: URL.createObjectURL(e.target.files[0]),
                  });
                  const reader1 = new FileReader();
                  // reader.readAsArrayBuffer(file);
                  // reader.onload = () => {setForm({...form,subPicture1:"data:image/jpeg;base64," + arrayBufferToBase64(reader.result),});};
            ...
            <div className="show-picture">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setForm({
                    ...form,
                    subPicture3: URL.createObjectURL(e.target.files[0]),
                  });
                  const reader1 = new FileReader();
                  // reader.readAsArrayBuffer(file);
                  // reader.onload = () => {setForm({...form,subPicture1:"data:image/jpeg;base64," + arrayBufferToBase64(reader.result),});};
            ...
            <div className="show-picture">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setForm({
                    ...form,
                    subPicture4: URL.createObjectURL(e.target.files[0]),
                  });
                  const reader1 = new FileReader();
                  // reader.readAsArrayBuffer(file);
                  // reader.onload = () => {setForm({...form,subPicture1:"data:image/jpeg;base64," + arrayBufferToBase64(reader.result),});};
      ...
      <div className="bottom-box">
        ...
        <div className="text-input-bottom">
          ...
          <div className="input-box-bottom">
            ...
            >
              <option value="สุนัขพันธ์นี้ชอบการเอาใจใส่ คุณมีเวลาเลี้ยงดูได้ไหม?">
                สุนัขพันธ์นี้ชอบการเอาใจใส่ คุณมีเวลาเลี้ยงดูได้ไหม?
              </option>
              <option value="สุนัขพันธ์นี้ไม่ควรอยู่ใกล้เด็กเล็ก คุณมีเด็กเล็กไหม?">
                สุนัขพันธ์นี้ไม่ควรอยู่ใกล้เด็กเล็ก คุณมีเด็กเล็กไหม?
              </option>
              <option value="สุนัขพันธ์นี้เสี่ยงเป็นโรคได้ง่าย คุณดูแลเรื่องอาหารได้ไหม?">
                สุนัขพันธ์นี้เสี่ยงเป็นโรคได้ง่าย คุณดูแลเรื่องอาหารได้ไหม?
              </option>
              <option value="สุนัขพันธ์นี้ต้องดูแลรักษาความสะอาดเป็นพิเศษ คุณดแลไดไหม?">
                สุนัขพันธ์นี้ต้องดูแลรักษาความสะอาดเป็นพิเศษ คุณดูแลได้ไหม?
              </option>
              <option value="สุนัขพันธ์นี้ชอบออกกำลัง คุณมีเวลาพาสุนัขไปออกกำลังกายไหม?">
                สุนัขพันธ์นี้ชอบออกกำลัง คุณมีเวลาพาสุนัขไปออกกำลังกายไหม?
              </option>
              <option value="สุนัขพันธ์นี้ชอบการเอาใจใส่ คุณมีเวลาเลี้ยงดูได้ไหม?">
                สุนัขพันธ์นี้ชอบการเอาใจใส่ คุณมีเวลาเลี้ยงดูได้ไหม?
              </option>
            ...
            >
              <option value="สุนัขพันธ์นี้ใช้ค่าใช้จ่ายในการเลี้ยงดูสูง คุณดูแลได้ไหม?">
                สุนัขพันธ์นี้ใช้ค่าใช้จ่ายในการเลี้ยงดูสูง คุณดูแลได้ไหม?{" "}
              </option>
              <option value="สุนัขพันธ์นี้ชอบเล่นน้ำ คุณดูแลได้หรือไม่?">
                สุนัขพันธ์นี้ชอบเล่นน้ำ คุณดูแลได้หรือไม่?
              </option>
              <option value="สุนัขพันธ์นี้ไม่เหมาะกับเลี้ยงในพื้นที่ปิด คุณมีสนามหญ้าไหม?">
                สุนัขพันธ์นี้ไม่เหมาะกับเลี้ยงในพื้นที่ปิด คุณมีสนามหญ้าไหม?
              </option>
              <option value="สุนัขพันธ์นี้ต้องการพื้นที่ในการวิ่งเล่นออกกำลังกาย คุณมีพื้นที่ไหม">
                สุนัขพันธ์นี้ต้องการพื้นที่ในการวิ่งเล่นออกกำลังกาย
                คุณมีพื้นที่ไหม
              </option>
              <option value="สุนัขพันธ์นี้ดุร้าย คุณดูแลได้ไหม">
                สุนัขพันธ์นี้ดุร้าย คุณดูแลได้ไหม
              </option>
            </select>
